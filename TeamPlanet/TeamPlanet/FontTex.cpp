...
void CCherClass::CreateCharTex(wchar_t c, HDC hdc, TEXTMETRIC TM)
{
	...
	FillMemory(pBits, 0x00, sizeof(DWORD) * 32 * 32);
...
void CFontTex::InitFontTex()
{
	...
	//第一引数のカテゴリに、第二引数の国別コードを影響を与える
	//この場合、Unicodeの文字を日本コードとなる
